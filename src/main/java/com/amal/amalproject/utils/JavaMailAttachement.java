...
public  class JavaMailAttachement {
	 public static boolean sendEmail(String from, String password, String to, String title, String content, String anexo){
	    ...
	    public static boolean sendEmailAll(final String from, final String password, String emails, String subject, String content,
	        String attach){   
